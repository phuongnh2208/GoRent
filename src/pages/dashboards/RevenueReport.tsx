    ...
    <div className="space-y-8 animate-in fade-in duration-500 pb-12">
      <div className="flex justify-between items-start">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Phân tích chuyên sâu về chỉ số tăng trưởng và hiệu quả kinh doanh.</p>
        </div>
        <div className="flex space-x-3">
           <button className="glass bg-white text-maroon px-4 py-2 rounded-xl text-xs font-bold border border-white/60 hover:bg-white/80 transition-all shadow-sm flex items-center">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <ResponsiveContainer width="100%" height="100%">
                 <AreaChart data={data}>
                    ...
                    <XAxis 
                       ...
                       axisLine={false} 
                       tickLine={false} 
                       tick={{fontSize: 10, fontWeight: 700, fill: '#80000060'}} 
                    />
                    <YAxis 
                       axisLine={false} 
                       tickLine={false} 
                    ...
                    />
                    <Tooltip 
                       contentStyle={{backgroundColor: '#fff', borderRadius: '16px', border: 'none', boxShadow: '0 10px 30px -10px rgba(128,0,0,0.1)'}}
                       itemStyle={{fontWeight: 700, color: '#800000'}}
                    />
        ...
        <div className="glass bg-white/40 rounded-[2.5rem] p-8 border border-white/20 shadow-xl shadow-maroon/5 text-maroon">
           <div className="flex items-center space-x-4 mb-8">
              <div className="p-3 bg-maroon/5 rounded-2xl"><TrendingUp className="w-6 h-6" /></div>
              <h3 className="text-sm font-bold uppercase tracking-widest">Hiệu suất tháng 6</h3>
           </div>
           
           <div className="space-y-8">
              <div>
                 <p className="text-[10px] font-bold opacity-40 uppercase mb-1">Doanh thu ròng</p>
                 <div className="flex items-end space-x-4">
                    <h4 className="text-5xl font-black">890.5M</h4>
              ...
              <div className="grid grid-cols-2 gap-6 pt-8 border-t border-maroon/5">
                 <div>
                    <p className="text-[10px] font-bold opacity-40 uppercase mb-2">Trung bình đơn</p>
                    <p className="text-xl font-bold">1.25M</p>
                 </div>
                 <div>
                    <p className="text-[10px] font-bold opacity-40 uppercase mb-2">Tỷ lệ tăng trưởng</p>
                    <p className="text-xl font-bold text-green-600">+4.2%</p>
                 </div>
              </div>

              <div className="bg-maroon text-white p-6 rounded-3xl shadow-xl shadow-maroon/20">
